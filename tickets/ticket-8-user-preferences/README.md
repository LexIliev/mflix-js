...
For this Ticket, you'll be required to implement one method in ***usersDAO.js***, **updatePreferences**. This method allows updates to be made to the _"preferences"_ field in the **users** collection.
